...
<head>
  ...
  <title>Sesion Solicitud-UACM</title>
    <!--Estilos-->
...
<div class="container">
  <div class="row" style="margin-top:20px">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
      <form action = "sesionBD.php" method = "post">
      <input type="hidden" name="submitted" value="true">
        <fieldset>
         <center><h2>Login Alumno</h2></center>
        <br><br>
        <hr>      
      <!--Matricula-->
      <div class="input-group">
          <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
          <input type="text" class="form-control" name="matricula" required="required" placeholder="Matricula">
      </div><br>
      <!--contraseña-->
      <div class="input-group">
